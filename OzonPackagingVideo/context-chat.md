...
- ### 2025-12-05 — добавлен CONTRIBUTING.md с правилами работы

- Создан файл `CONTRIBUTING.md`.
- В нём описаны правила:
  - как ассистент даёт код (с опорными строками и полными блоками);
  - что после каждой удачной сборки ассистент даёт текст сообщения коммита и просит сделать commit + push;
  - что ассистент может анализировать код из репозитория после push;
  - как вести `context-chat.md` и `README.md`.
